...
class _SportsNewsState extends State<SportsNews> {
  ...
  Future<List<Article>> getArticle() async {
    Uri endpointUrl = Uri.parse('https://newsapi.org/v2/everything?q=sports&from=2022-08-07&sortBy=publishedAt&apiKey=c882c51d110f4e01a4631584f7aecb6a');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('SPORTS', style: GoogleFonts.robotoSlab(color: Colors.amber.shade100,fontSize: 29, letterSpacing: 5, fontWeight: FontWeight.bold),),
      ),
      body: SafeArea(
