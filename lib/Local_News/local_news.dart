...
class _LocalNewsState extends State<LocalNews> {
  ...
  Future<List<Article>> getArticle() async {
    //USE YOUR OWN API KEY HERE IF YOU PULL THE CODE
    Uri endpointUrl = Uri.parse('https://newsapi.org/v2/everything?q=haryana&from=2022-08-07&sortBy=publishedAt&apiKey=c882c51d110f4e01a4631584f7aecb6a');
